(function ($) {
  ...
  $(document).on("scroll", function () {
    ...
    if (
      currentScroolValue >= 100 &&
      currentScroolValue < $(".st-single-inner-content").height()
    ) {
      $(".st-single-sticky-footer").css({
        background: "white",
        transition: "400ms",
        bottom: "0",
      });
      ...
      currentScroolValue >= $(".st-single-inner-content").height() &&
      currentScroolValue < $(".st-single-inner-content").height() + 200
    ) {
      $(".st-sf-content-1").css({
        transition: "300ms",
        opacity: "0",
      ...
      currentScroolValue >=
      $(".st-single-inner-content").height() + commentsHeight
    ) {
      $(".st-single-sticky-footer").css({
        transition: "300ms",
        bottom: "-90px",
